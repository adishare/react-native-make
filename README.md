...
```bash
yarn add -D @adishare/react-native-make
# OR
npm i -D @adishare/react-native-make
```
...
- In your React Native project, `yarn link @adishare/react-native-make`
- In the package.json of your React Native project, in dependencies add "@adishare/react-native-make" : "0.0.0"
